...
class OrdenProducto(models.Model):
    ...
    size = models.ForeignKey(Tamaño, related_name="ordenProduct", on_delete=models.PROTECT, default="", blank=True, null=True)
    ...
    def __str__(self):
        return f'{self.cantidad} - {self.name} en orden - {self.orden.id}  {self.orden.usuario}'
